...
def initialize_robots(arena_size=-1, particle_box=-1): # particle_box: size of the robot enclosed in a square
    ...
    robots = []
    robots.append(robot_braitenberg_hateBot.Robot_player(x_left, y_mid, 0, name="hb1", team="A"))
    robots.append(robot_braitenberg_hateBot.Robot_player(x_right, y_mid, 180, name="hb2", team="B"))
    return robots
